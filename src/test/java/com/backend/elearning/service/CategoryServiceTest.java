...
public class CategoryServiceTest {
    ...
    void beforeEach() {
        ...
        sms.addMessage("CATEGORY_NOT_FOUND", Locale.ENGLISH, "Category {0} is not found");
        sms.addMessage("CATEGORY_NAME_DUPLICATED", Locale.ENGLISH,
                "Category with name {0} is duplicated");
